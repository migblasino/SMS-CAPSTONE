                  ...
                  <div class="card-body">
                    ...
                    <div class="d-flex flex-wrap mb-5">
                      ...
                      <div class="me-5 mt-3">
                        ...
                        <h3 class="text-primary fs-30 font-weight-medium">92</h3>
                      </div>
                      <div class="me-5 mt-3">
                ...
                <div class="card">
                  <div class="card-body">
                    ...
                    <ul class="icon-data-list">
                      <li>
                        <div class="d-flex">
                          <img src="{{ asset('img/faces/face1.jpg') }}" alt="user">
                          <div>
                      ...
                      <li>
                        <div class="d-flex">
                          <img src="{{ asset('img/faces/face2.jpg') }}" alt="user">
                          <div>
                      ...
                      <li>
                        <div class="d-flex">
                          <img src="{{ asset ('img/faces/face3.jpg') }}" alt="user">
                          <div>
                      ...
                      <li>
                        <div class="d-flex">
                          <img src="{{ asset ('img/faces/face4.jpg') }}" alt="user">
                          <div>
                      ...
                      <li>
                        <div class="d-flex">
                          <img src="{{ asset ('img/faces/face5.jpg') }}" alt="user">
                          <div>'
